...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Simple web scrapper, built on top of nokogiri and httparty gems.}
  spec.description   = %q{Simple web scrapper, built on top of nokogiri and httparty gems.}
